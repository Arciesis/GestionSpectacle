...
public class Main {
    public static void main(String args[]) {
        ...
        Creneau c1 = new Creneau(1, new Horaire(12, 30), new Horaire(14, 30));
        System.out.println(s.pasDeCreneauCeJour(c1.getJour()));
        System.out.println(s.pasDeCreneauCeJour(2));
